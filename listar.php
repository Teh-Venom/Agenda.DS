					...
					<form action="" method="POST">
						...
						<fieldset>
							...
							<table border="1" style ="margin : 0 auto">
								...
								<?php
									include "conexao.php";
									$sql = "SELECT entidade.idEntidade, entidade.primeiroNome, listagrupo.nome, entidade.sexo, entidade.dataNascimento, telefone.numero, endereco.rua, email.endereco, entidade.Obs FROM entidade INNER JOIN listagrupo ON listagrupo.idListaGrupo = entidade.IdListaGrupo_Entidade INNER JOIN endereco ON endereco.idEntidade_Endereco = entidade.idEntidade INNER JOIN telefone ON telefone.idEntidade_Telefone = entidade.idEntidade INNER JOIN email ON email.idEntidade_Email = entidade.idEntidade INNER JOIN cidade ON cidade.idCidade = endereco.idCidade_Endereco INNER JOIN listatipotelefone ON listatipotelefone.idListaTipoTelefone = telefone.idListaTipoTelefone_Telefone";
